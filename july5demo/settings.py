"""
Django settings for july5demo project.
...
SECRET_KEY = 'django-insecure-#nfpfc_*5%^)#yiv1kz&k*pbrxry^(n+279kkau84b20rkr7vz'
...
WSGI_APPLICATION = 'july5demo.wsgi.application'
